        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (System.currentTimeMillis() - start > 1000) {
                    log.warn("Netty DefaultChannelId initialization (with com.couchbase.client.core.deps.io.netty.machineId" +
                            " system property set to " + System.getProperty("com.couchbase.client.core.deps.io.netty.machineId")
