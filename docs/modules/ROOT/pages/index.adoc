...
You can enable Micrometer metrics by adding quarkus-micrometer to your dependencies, and setting `quarkus.couchbase.metrics.enabled=true` in `application.properties`.
